...
<div class="container shop2.1">
	<p class="shop2">
		<img src="<%=request.getContextPath()%>/img/shop2.png" class="shop2" />
	</p>
</div>
<script>
	$(function() {
						...
						for (var i = 1; i < data.length; i++) {
							...
							var td2 = $("<td>").html(
								'<a href="${pageContext.request.contextPath}/Detail?no='
									+ data[i].no
									+ '&uri=dietboard"><img src="${pageContext.request.contextPath}/upload/'+data[i].file+' "width="300" height="200">'
									+ '</a>' + "<p>"
									)
							var td3 = $("<td>").html(
									"<a href='${pageContext.request.contextPath}/Detail?no="
									+ data[i].no + "&uri=dietboard'>"
									+ data[i].title + "</a>");
