...
<div class="container">
	<p class="shop1">
		<img src="<%=request.getContextPath()%>/img/shop1.jpg" />
	</p>
</div>
						...
						for (var i = 1; i < data.length; i++) {
							...
							var td2 = $("<td>").html(
								'<a href="${pageContext.request.contextPath}/Detail?no='
									+ data[i].no
									+ '&uri=eatboard"><img src="${pageContext.request.contextPath}/upload/'+data[i].file+' "width="300" height="200">'
									+ '</a>' + "<p>"
									)
							var td3 = $("<td>").html(
									"<a href='${pageContext.request.contextPath}/Detail?no="
									+ data[i].no + "&uri=eatboard'>"
									+ data[i].title + "</a>");
