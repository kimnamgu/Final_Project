...
<div class="container">
	<p class="healthlogo"><img src="<%=request.getContextPath()%>/img/healthlogo.jpg"/></p>
</div>
	...
	$(function(){
		$.ajax({
				...
				for(var i=1; i<data.length; i++){
					...
					var td2 = $("<td>").html(
								'<a href="${pageContext.request.contextPath}/Detail?no='
									+ data[i].no
									+ '&uri=health"><img src="${pageContext.request.contextPath}/upload/'+data[i].file+' "width="300" height="200">'
									+ '</a>' + "<p>"
									)
			...
			error : function(xhr, textStatus, errorThrown) {
				$("#list").html(textStatus + "(HTTP-" + xhr.status + "/" + errorThrown);
			}
		});
	});
</script>
